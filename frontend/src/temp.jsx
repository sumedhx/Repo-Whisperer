  ...
  return (
    <ThemeProvider theme={theme}>
      <Container
        ...
        maxWidth={false}
        disableGutters
        sx={{ width: '100vw', height: '100vh', bgcolor:'ThreeDDarkShadow', p:2,
          display: 'flex',
          justifyContent: 'space-between',
          flexDirection: { xs: 'column', md: 'row' },
        }}
      >
        <Container className="main" sx={{ flex: 7, bgcolor: 'white' }} disableGutters>
          <header>
          ...
          <Box sx={{
            bgcolor:'', height:'calc(100% - 7vh)', p:4, 
            ...
            <Box className='answer-box' sx={{
              ...
              <Box className='file-details' sx={{display:'flex', alignItems:'center', justifyContent:'space-between', px:4}}>
